...
func TestAccAWSGameliftFleet_allFields(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAWSGameliftFleetAllFieldsConfig(fleetName, desc, launchPath, params, buildName, bucketName, key, roleArn),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSGameliftFleetExists("aws_gamelift_fleet.test", &conf),
					resource.TestCheckResourceAttrSet("aws_gamelift_fleet.test", "build_id"),
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "ec2_instance_type", "c4.large"),
					...
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "runtime_configuration.0.server_process.1.launch_path", launchPath),
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "runtime_configuration.0.server_process.1.parameters", params[1]),
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "runtime_configuration.0.server_process.2.concurrent_executions", "5"),
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "runtime_configuration.0.server_process.2.launch_path", launchPath),
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "runtime_configuration.0.server_process.2.parameters", params[2]),
				),
			},
			{
				Config: testAccAWSGameliftFleetAllFieldsUpdatedConfig(fleetName, desc, launchPath, params, buildName, bucketName, key, roleArn),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSGameliftFleetExists("aws_gamelift_fleet.test", &conf),
					resource.TestCheckResourceAttrSet("aws_gamelift_fleet.test", "build_id"),
					resource.TestCheckResourceAttr("aws_gamelift_fleet.test", "ec2_instance_type", "c4.large"),
...
%s
`, fleetName, desc, launchPath, params[0],
		launchPath, params[1],
		launchPath, params[2],
...
%s
`, fleetName, desc, launchPath, params[0], launchPath, params[1],
		testAccAWSGameliftFleetBasicTemplate(buildName, bucketName, key, roleArn))
}
